    ...
    <>
      ...
      <section className="section">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12">
                ...
                {[
                  {
                    ...
                    value:
                      "Rama Equator, Office No 612, Near Finolex Chowk, Morwadi, Pimpri, Pune, India – 411 018",
                  },
                  {
                    icon: "🏭",
                  ...
                  { icon: "🌐", label: "Website", value: "www.chemsept.in " },
                ].map(({ icon, label, value, href }) => (
                  <div
                    key={label}
                    className="flex items-start gap-4 p-5 rounded-xl bg-[var(--c-slate)] border border-[var(--c-border)]"
                  >
                    <div className="w-10 h-10 flex items-center justify-center rounded-lg shrink-0 bg-[rgba(30,58,110,0.1)]">
                      {icon}
                    </div>
                    <div>
                      <p className="text-xs font-bold uppercase tracking-widest mb-1 text-[var(--c-navy)]">
                        {label}
                      </p>
                      {href ? (
                        <a
                          href={href}
                          className="text-sm font-medium text-[var(--c-text-mid)] hover:text-[var(--c-coral)] transition-colors"
                        >
                          {value}
                        </a>
                      ) : (
                        <p className="text-sm text-[var(--c-text-mid)]">
                          {value}
                        </p>
                      )}
                    </div>
            ...
            >
              <h3 className="font-bold text-xl mb-2 text-[var(--c-navy)]">
                Send Us a Message
              </h3>
              <p className="text-sm mb-7 text-[var(--c-text-muted)]">
      ...
      <div className="py-12 bg-[var(--c-slate)] border-t border-[var(--c-border)]">
        <div className="container text-center">
          <h3 className="font-bold text-lg mb-2 text-[var(--c-navy)]">
            Our Location
          </h3>
          <p className="text-sm mb-6 text-[var(--c-text-muted)]">
