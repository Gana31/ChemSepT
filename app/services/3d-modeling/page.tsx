...
const capabilities = [
  "Piping Design & Analysis", "Stress Analysis",
  "3D Modelling of Pharmaceutical Plants", "Chemical Plant Modelling",
  "Petrochemical Plant Design", "Petroleum Refinery Layout",
  "Structural Steel Detailing", "Isometric Drawing Generation",
];
  ...
  return (
    <>
      <div className="relative h-[280px] md:h-[340px] overflow-hidden">
        <Image src="/images/banners/page-banner.jpg" alt="3D Plant Modeling" fill quality={90} className="object-cover" sizes="100vw" />
        ...
        <div className="container relative z-10 h-full flex flex-col items-center justify-center text-center">
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
            className="text-4xl md:text-5xl font-extrabold text-white mb-3">3D Plant Modeling</motion.h1>
          <div className="flex items-center gap-2 text-sm text-white/70">
            <Link href="/" className="text-[var(--c-coral-light)] hover:text-white transition-colors">Home</Link>
            <span className="text-white/40">›</span>
            <Link href="/services/3d-modeling" className="text-[var(--c-coral-light)] hover:text-white transition-colors">Services</Link>
            <span className="text-white/40">›</span><span>3D Plant Modeling</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-14 items-start">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              ...
              <p className="mt-5 leading-relaxed text-[var(--c-text-mid)]">
                Piping design, Stress analysis and 3D modelling of pharmaceutical, chemical, petrochemical and petroleum
                plant. Our 3D modeling services provide clients with detailed visualizations of their process plants.
              </p>

              {/* 3D Modeling Image Gallery */}
              <ServiceImageSlider 
                images={[
                  { src: "/images/services/3d-modeling-1.jpg", alt: "3D Plant Model 1" },
                  { src: "/images/services/3d-modeling-2.jpg", alt: "3D Plant Model 2" },
                  { src: "/images/services/3d-modeling-3.jpg", alt: "3D Plant Model 3" }
                ]}
              />

              <div className="mt-8">
                <h3 className="font-bold text-base mb-4 text-[var(--c-navy)]">Our Expertise:</h3>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}
              ...
              <div className="card text-center py-8">
                ...
                <h3 className="font-bold text-base mb-2 text-[var(--c-navy)]">Need 3D Modeling?</h3>
                <p className="text-sm mb-6 text-[var(--c-text-muted)]">Get accurate 3D models of your plant design.</p>
