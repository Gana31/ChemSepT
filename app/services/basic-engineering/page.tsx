  ...
  return (
    <>
      <div className="relative h-[280px] md:h-[340px] overflow-hidden">
        <Image src="/images/banners/page-banner.jpg" alt="Basic Engineering" fill quality={90} className="object-cover" sizes="100vw" />
        ...
        <div className="container relative z-10 h-full flex flex-col items-center justify-center text-center">
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
            className="text-4xl md:text-5xl font-extrabold text-white mb-3">Basic Engineering Packages</motion.h1>
          <div className="flex items-center gap-2 text-sm text-white/70">
            <Link href="/" className="text-[var(--c-coral-light)] hover:text-white transition-colors">Home</Link>
            <span className="text-white/40">›</span>
            <Link href="/services/basic-engineering" className="text-[var(--c-coral-light)] hover:text-white transition-colors">Services</Link>
            <span className="text-white/40">›</span>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-14 items-start">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              ...
              {/* Service Image */}
              {/* Service Image */}
              <ServiceImageSlider images={[{ src: "/images/services/basic-engineering-detail.jpg", alt: "Basic Engineering" }]} />

              <div className="mt-8">
                <h3 className="font-bold text-base mb-4 text-[var(--c-navy)]">BEP Includes:</h3>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}
              ...
              <div className="card text-center py-8">
                ...
                <h3 className="font-bold text-base mb-2 text-[var(--c-navy)]">Get Your BEP</h3>
                <p className="text-sm mb-6 text-[var(--c-text-muted)]">Ready to get started? Contact us for a detailed proposal.</p>
